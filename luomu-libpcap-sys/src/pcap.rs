...
pub const PCAP_SRC_FILE_STRING: &[u8; 8usize] = b"file://\0";
pub const PCAP_SRC_IF_STRING: &[u8; 9usize] = b"rpcap://\0";
...
fn bindgen_test_layout_pcap_file_header() {
    const UNINIT: ::core::mem::MaybeUninit<pcap_file_header> = ::core::mem::MaybeUninit::uninit();
    let ptr = UNINIT.as_ptr();
    assert_eq!(
    ...
    assert_eq!(
        unsafe { ::core::ptr::addr_of!((*ptr).thiszone) as usize - ptr as usize },
        8usize,
        concat!(
            "Offset of field: ",
            stringify!(pcap_file_header),
    ...
    assert_eq!(
        unsafe { ::core::ptr::addr_of!((*ptr).sigfigs) as usize - ptr as usize },
        12usize,
        concat!(
            "Offset of field: ",
            stringify!(pcap_file_header),
    ...
    assert_eq!(
        unsafe { ::core::ptr::addr_of!((*ptr).snaplen) as usize - ptr as usize },
        16usize,
        concat!(
            "Offset of field: ",
            stringify!(pcap_file_header),
    ...
    assert_eq!(
        unsafe { ::core::ptr::addr_of!((*ptr).linktype) as usize - ptr as usize },
        20usize,
        concat!(
            "Offset of field: ",
            stringify!(pcap_file_header),
...
fn bindgen_test_layout_pcap_stat() {
    const UNINIT: ::core::mem::MaybeUninit<pcap_stat> = ::core::mem::MaybeUninit::uninit();
    let ptr = UNINIT.as_ptr();
    assert_eq!(
    ...
    assert_eq!(
        unsafe { ::core::ptr::addr_of!((*ptr).ps_recv) as usize - ptr as usize },
        0usize,
        concat!(
            "Offset of field: ",
            stringify!(pcap_stat),
    ...
    assert_eq!(
        unsafe { ::core::ptr::addr_of!((*ptr).ps_drop) as usize - ptr as usize },
        4usize,
        concat!(
            "Offset of field: ",
            stringify!(pcap_stat),
    ...
    assert_eq!(
        unsafe { ::core::ptr::addr_of!((*ptr).ps_ifdrop) as usize - ptr as usize },
        8usize,
        concat!(
            "Offset of field: ",
            stringify!(pcap_stat),
...
fn bindgen_test_layout_pcap_if() {
    const UNINIT: ::core::mem::MaybeUninit<pcap_if> = ::core::mem::MaybeUninit::uninit();
    let ptr = UNINIT.as_ptr();
    assert_eq!(
...
fn bindgen_test_layout_pcap_addr() {
    const UNINIT: ::core::mem::MaybeUninit<pcap_addr> = ::core::mem::MaybeUninit::uninit();
    let ptr = UNINIT.as_ptr();
    assert_eq!(
    ...
    assert_eq!(
        unsafe { ::core::ptr::addr_of!((*ptr).broadaddr) as usize - ptr as usize },
        24usize,
        concat!(
            "Offset of field: ",
            stringify!(pcap_addr),
...
>;
extern "C" {
    pub fn pcap_init(arg1: libc::c_uint, arg2: *mut libc::c_char) -> libc::c_int;
}
extern "C" {
...
fn bindgen_test_layout_pcap_rmtauth() {
    const UNINIT: ::core::mem::MaybeUninit<pcap_rmtauth> = ::core::mem::MaybeUninit::uninit();
    let ptr = UNINIT.as_ptr();
    assert_eq!(
...
fn bindgen_test_layout_pcap_samp() {
    const UNINIT: ::core::mem::MaybeUninit<pcap_samp> = ::core::mem::MaybeUninit::uninit();
    let ptr = UNINIT.as_ptr();
    assert_eq!(
